...
;(function($) {
	$(document).ready(function() {
		...
		var homeCallPic = '<div>\
							<a href="#"><img src="assets/icons_row/ion-edit - Ionicons Copy.png"><br/><span>Edit</span></a>\
							<a href="#"><img src="assets/icons_row/Copy Copy 2.png"><br/><span>Copy</span></a>\
							<a href="#"><img src="assets/icons_row/ion-android-delete - Ionicons Copy 2.png"><br/><span>Delete</span></a>\
							<a href="#"><img src="assets/icons_row/calendar (12) copy.png"><br/><span>Registration</span></a>\
							<a href="#"><img src="assets/icons_row/clock (6).png"><br/><span>Timesheet</span></a>\
							<a href="#"><img src="assets/icons_row/chat (5) copy.png"><br/><span>Message</span></a>\
						   </div>';
//call popup, pass through options
	//	$('div[data-popup="myPopUp"]').popup({	//call popup on the element the popup will be attached to
		...
		$('.myPopUp1,.myPopUp2,.myPopUp3,.myPopUp4,.myPopUp5,.myPopUp6,.myPopUp7,.myPopUp8,.myPopUp9,.myPopUp10').popup({	
			content: homeCallPic,	
